...
# Apps are killed between iterations for clean measurements.
#
...
print_usage() {
    ...
    echo ""
    echo "Measures macOS app startup time using wall-clock timing."
    echo ""
...

{
    ...
    echo "$AVG,$MEDIAN,$MIN,$MAX,$STDEV,$COUNT,$SAMPLE_APP,$BUILD_CONFIG,osx,$PACKAGE_SIZE_MB,$PACKAGE_SIZE_BYTES"
} > "$RESULT_FILE"
